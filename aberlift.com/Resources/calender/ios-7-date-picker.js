...
*/
        ...
        Cal.prototype.buildDOM = function() {
            ...
            html += "<div class='row th'>\n<div class='C'>M</div>\n<div class='C'>T</div>\n<div class='C'>W</div>\n<div class='C'>T</div>\n<div class='C'>F</div>\n<div class='C'>S</div>\n<div class='C'>S</div>\n</div>\n<div class='"+this.markup.dayArea+"'>\n";
            //html += "</div>\n\n<div class='row nav'>\n\n<i class='btn prev prev-month fa fa-play fa-flip-horizontal'></i>\n<i class='btn next next-month fa fa-play'></i>\n</div>\n</div>\n</div>\n";
            html += "</div>\n\n<div class='row nav'>\n\n<i class='btn prev prev-month button-left-icon'></i>\n<i class='btn next next-month button-right-icon'></i>\n</div>\n</div>\n</div>\n";
            //html += "</div>\n\n<div class='row nav'>\n\n<i class='btn prev prev-month' style='background-image:url('http://google.github.io/material-design-icons/navigation/svg/ic_arrow_back_24px.svg');background-repeat:no-repeat;background-position:center;background-size:24px;''></i>\n<i class='btn next next-month' style='background-image:url('http://google.github.io/material-design-icons/navigation/svg/ic_arrow_back_24px.svg');background-repeat:no-repeat;background-position:center;background-size:24px;'></i>\n</div>\n</div>\n</div>\n";
            $(html).insertAfter(this.targetInput);
            $(this.targetInput).css('cursor','pointer');
            this.hide(0);
        }
